      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="bg-secondary rounded-3xl p-8 border border-border sticky top-28">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-foreground mt-4">{instructor.name}</h3>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="p-4 bg-white rounded-xl border border-border hover:border-primary/30 hover:shadow-md transition-all premium-hover">
